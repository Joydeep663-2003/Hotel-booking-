...
// ✅ Sample hotel data (15 luxury hotels)
const experiences = [
  {
    _id: "1",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1501117716987-c8e1ecb21029?w=800",
    price: 22000,
  },
  {
    _id: "3",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1576671081837-49000212a0b3?w=800",
    price: 15500,
  },
  {
    _id: "7",
    ...
    image:
      "https://images.unsplash.com/photo-1582719478173-2d66e7a74a14?w=800",
    price: 14500,
  },
  {
    _id: "8",
...
app.get("/api/experiences/:id", (req, res) => {
  const { id } = req.params;
  const hotel = experiences.find((exp) => exp._id === id);
  if (!hotel) {
